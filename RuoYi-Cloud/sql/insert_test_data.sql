...
-- 清理科室数据（注意：dept_id 200以上可能是测试数据）
DELETE FROM `sys_dept` WHERE `dept_id` BETWEEN 200 AND 299;
...
-- ======================== 3. 医生数据 ========================
INSERT IGNORE INTO `doctor` (`doctor_id`, `user_id`, `dept_id`, `doctor_no`, `doctor_name`, `gender`, `phone`, `level_id`, `specialty`, `introduction`, `status`, `create_time`, `update_time`) VALUES
(1, 1, 201, 'DOC001', '李明', '0', '13900000001', 3, '擅长心血管疾病、高血压、冠心病的诊断与治疗，从事临床工作20余年。', '毕业于北京医科大学，硕士学位，主任医师，心血管内科副主任。', '0', NOW(), NOW()),
(2, 1, 201, 'DOC002', '王芳', '1', '13900000002', 2, '擅长消化系统疾病，包括胃炎、胃溃疡、肠炎等疾病的诊疗。', '毕业于上海医科大学，博士学位，副主任医师。', '0', NOW(), NOW()),
(3, 1, 202, 'DOC003', '张伟', '0', '13900000003', 3, '擅长普外科疾病，包括疝气、阑尾炎、胆囊结石等微创手术。', '从事外科临床工作25年，经验丰富。', '0', NOW(), NOW()),
(4, 1, 203, 'DOC004', '刘静', '1', '13900000004', 2, '擅长小儿常见病、多发病，如感冒、发烧、咳嗽、腹泻等。', '儿科专家，深受患儿家长信赖。', '0', NOW(), NOW()),
(5, 1, 204, 'DOC005', '陈红', '1', '13900000005', 3, '擅长妇科疾病、不孕不育、产前检查等。', '妇产科主任，从事临床工作30年。', '0', NOW(), NOW());
