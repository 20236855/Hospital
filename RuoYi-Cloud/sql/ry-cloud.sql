...
INSERT INTO `sys_menu` VALUES (2039, '处方', 2007, 1, 'prescription', 'hisprescription/prescription/index', NULL, '', 1, 0, 'C', '0', '0', 'hisprescription:prescription:list', '#', 'admin', '2026-06-02 16:24:20', '', NULL, '处方菜单');
INSERT INTO `sys_menu` VALUES (2040, '处方查询', 2039, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'hisprescription:prescription:query', '#', 'admin', '2026-06-02 16:24:20', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2041, '处方新增', 2039, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'hisprescription:prescription:add', '#', 'admin', '2026-06-02 16:24:20', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2042, '处方修改', 2039, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'hisprescription:prescription:edit', '#', 'admin', '2026-06-02 16:24:20', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2043, '处方删除', 2039, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'hisprescription:prescription:remove', '#', 'admin', '2026-06-02 16:24:20', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2044, '处方导出', 2039, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'hisprescription:prescription:export', '#', 'admin', '2026-06-02 16:24:20', '', NULL, '');
